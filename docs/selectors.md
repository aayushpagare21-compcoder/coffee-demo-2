...
| 4 | `#opti-snippet-onerror-shim` | `<script>` |
...
| `#opti-snippet-onerror-shim` | `<script>` | _(no text)_ |
...
**84 elements** in the server HTML, **6 page-specific ids** plus the 32 global ids below.
...
**79 elements** in the server HTML, **0 page-specific ids** plus the 32 global ids below.
