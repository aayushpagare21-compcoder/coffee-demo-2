...
| order | id | tag |
| --- | --- | --- |
| 1 | `#opti-snippet-preconnect` | `<link>` |
| 2 | `#opti-snippet-inline` | `<script>` |
| 3 | `#opti-snippet-async-1` | `<script async src>` |
| 4 | `#opti-snippet-async-2` | `<script async src>` |
| 5 | `#opti-snippet-onerror-shim` | `<script>` |
...
| id | tag | visible text |
| --- | --- | --- |
| `#opti-snippet-preconnect` | `<link>` | _(no text)_ |
