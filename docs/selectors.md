...
| order | id | tag | source |
| --- | --- | --- | --- |
| 1 | `#opti-snippet-style` | `<style>` | `STYLE_CONTENT` |
...
| id | tag | visible text |
| --- | --- | --- |
| `#opti-snippet-style` | `<style>` | _(no text)_ |
...
**3137 elements** in the server HTML, **326 page-specific ids** plus the 32 global ids below.
